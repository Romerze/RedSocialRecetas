...
@section('content')
    <h2 class="text-center mb-5"><span><i class="fas fa-book"></i></span> Crear Nueva Receta</h2>
        ...
        <div class="col-md-8">
            <form  method="POST" action="{{ route('recetas.store') }}" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="titulo" class="form-control @error('titulo') is-invalid @enderror" id="titulo" placeholder="Título Receta" value="{{ old('titulo') }}">
